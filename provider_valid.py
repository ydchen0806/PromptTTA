...
class Provider_valid(Dataset):
    def __init__(self, cfg, valid_data=None, num_z=18, test=False, test_split=None):
        ...
        if valid_dataset_name == 'cremiA':
            ...
            self.sub_path = 'wafer26'
            self.train_datasets = ['wafer.h5']
            self.train_labels = ['wafer4_labels.h5']
        ...
        if cfg.MODEL.model_type == 'mala':
            ...
            if 'fib' in valid_dataset_name:
                padding_xy = 20
                num_xy = 6
            elif 'cremiA' in valid_dataset_name or 'cremiB' in valid_dataset_name or 'cremiC' in valid_dataset_name or 'wafer4' in valid_dataset_name or 'wafer26' in valid_dataset_name:
                padding_xy = 15
                num_xy = 15
            else:
                padding_xy = 48
