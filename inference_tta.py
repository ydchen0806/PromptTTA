...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--cfg', type=str, default='seg_3d_wafer26_data100', help='path to config file')
    parser.add_argument('-mn', '--model_name', type=str, default='2023-10-02--15-36-33_seg_3d_wafer26_data80')
    parser.add_argument('-id', '--model_id', type=int, default=190000)
    parser.add_argument('-m', '--mode', type=str, default='wafer26')
    parser.add_argument('-ts', '--test_split', type=int, default=125)
    ...
    with open('/braindat/lab/chenyd/code_230508/wafer4/config/' + cfg_file, 'r') as f:
    ...
    out_path = os.path.join('/braindat/lab/chenyd/code_230508/wafer4/inference', trained_model, args.mode)
    ...
    ckpt_path = os.path.join('/braindat/lab/liuxy/Backbones/models/2023-10-02--13-35-44_seg_3d_wafer4_data100/model-190000.ckpt')
